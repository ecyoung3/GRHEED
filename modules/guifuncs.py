...
def findPeaks(
    ...
    **kwargs):
    ...
    #     vline.setHoverPen(hover)
        ...
        # # Add the line to the plot at the peak position
        # vline.setPos(freq[peak])
        # self.fftPlotAxes.addItem(vline)
...
def filterData(
        ...
        method: str = 'savitzky-golay', 
        **kwargs):
    # Savitzky-Golay filter removes high-frequency noise
